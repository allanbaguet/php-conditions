    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">Créer une variable <strong>isEasy</strong> de type booléan et l'initialiser avec une valeur. <br>
                    Afficher C'est facile !! si c'est vrai. Dans le cas contraire afficher C'est difficile !!!. <br>
                    <strong>Bonus</strong> : L'écrire de deux manières différentes.
                </p>
            </div>
        </div>
    </div>
